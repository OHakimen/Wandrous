...
public class WandrousRegistries {
    ...
    public static final ResourceKey<Registry<ISpellMover>> IMOVER_REGISTER_KEY = ResourceKey.createRegistryKey(new ResourceLocation(Wandrous.MODID, "spell_mover"));
