...
public class SpellStatus {
    ...
    public float getDamage() {
        ...
        return (damage * (1f + getDamageMod())) * (random.nextFloat(0, 1) < getCritChance() ? 5f : 1f) * (getCritChance() > 1 ? getCritChance() : 1);
    }
    ...
    public int getLifeTime() {
        return (int) (lifeTime * (1 + getLifetimeMod()));
    }
